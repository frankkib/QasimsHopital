      ...
      <div className="relative p-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          <div className="text-center">
            <h1 className="text-xl font-bold mb-2">Laboratory Services</h1>
          ...
          <div className="text-center">
            <h1 className="text-xl font-bold mb-2">Maternity Services</h1>
          ...
          <div className="text-center">
            <h1 className="text-xl font-bold mb-2">Home Care Services</h1>
